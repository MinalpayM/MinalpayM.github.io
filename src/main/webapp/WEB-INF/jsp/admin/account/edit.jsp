...
<div class="container">
    <div class="card">
        <h2 style="margin-bottom: 30px;">编辑账号</h2>
        
        <div class="info-text">
            <strong>账号ID:</strong> ${user.userId} |
            <strong>创建时间:</strong> ${user.createTime}
        </div>
        ...
        <form action="${pageContext.request.contextPath}/admin/account/update" method="post">
            ...
            <div class="form-group">
                ...
                <small style="color: #666;">如不修改密码，请留空</small>
            </div>
    		...
    		<select id="doctorId" name="doctorId">
            	...
            	<option value="${doctor.doctorId}" 
                	...
                	医生ID: ${doctor.doctorId} - ${doctor.name}
            	</option>
        		</c:forEach>
    		</select>
